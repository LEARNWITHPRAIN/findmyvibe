  ...
  return (
    <>
      ...
      {showCongratsModal && currentUser.verification_status === 'verified' && (
        <div className="fixed inset-0 z-[100] bg-zinc-950/85 backdrop-blur-md flex items-center justify-center p-4 animate-fade-in">
          <div className="relative w-full max-w-lg bg-zinc-900 border border-teal-500/40 rounded-3xl p-6 sm:p-8 shadow-2xl shadow-teal-500/10 text-center space-y-6 overflow-hidden">
            {/* Ambient Glow */}
            ...
            {/* Shield / Success Icon */}
            <div className="relative mx-auto w-20 h-20 rounded-3xl bg-gradient-to-br from-teal-500/20 to-purple-500/20 border-2 border-teal-400/50 flex items-center justify-center text-teal-400 shadow-glow-teal">
            ...
            <div className="bg-zinc-950/70 border border-zinc-800/80 rounded-2xl p-4 text-left space-y-3">
              ...
              <div className="space-y-2 text-xs text-zinc-300">
                <div className="flex items-center gap-2.5">
                  ...
                  <span><strong>Full Profiles Unlocked:</strong> View student photos, departments & years without lock screens.</span>
                </div>
                <div className="flex items-center gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-teal-400 shrink-0" />
                  <span><strong>Direct Chat Active:</strong> Message batchmates and collaborate for campus clubs & events.</span>
                </div>
                <div className="flex items-center gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-teal-400 shrink-0" />
            ...
            <div className="pt-2 flex flex-col sm:flex-row gap-3">
              <Link
                href="/discover"
                onClick={handleDismissCongrats}
                className="flex-1 py-3 px-5 rounded-xl bg-gradient-to-r from-purple-600 via-rose-500 to-teal-500 hover:from-purple-500 hover:to-teal-400 text-white font-bold text-sm shadow-glow-purple flex items-center justify-center gap-2 transition-all"
              >
              ...
              <button
                onClick={handleDismissCongrats}
                className="py-3 px-5 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-zinc-300 text-sm font-semibold transition-colors"
              >
                Dismiss
              </button>
            </div>
